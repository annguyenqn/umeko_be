...
async function seedLessons() {
  ...
  // Mảng mô tả cho N2 (dựa trên các unit và bài từ danh sách URL)
  const descriptions = [
// Unit 1: Con người
...
// Unit 8: Công nghiệp - Nông nghiệp
...
]; // Seed N2 (dựa trên số lượng bài trong mảng descriptions)

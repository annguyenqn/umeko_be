...
const vocab_mimikara_n3_1 = require("./data/vocab-mimikara-n3");
async function seedVocabs(vocabs) {
    ...
    for (const vocabItem of vocabs) {
        ...
        const lesson = await lessonRepo.findOne({
            where: { lesson_number: vocabItem.lesson_number, level: 'N3' },
        });
        if (!lesson) {
            failedVocabs.push({
...
seedVocabs(vocab_mimikara_n3_1.vocabMimikaraSeedN3Data)
    .catch((err) => {
...
//# sourceMappingURL=seed_vocabMimikaraN3.js.map
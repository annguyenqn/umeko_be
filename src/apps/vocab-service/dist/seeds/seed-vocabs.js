...
const vocab_seed_data_1 = require("./data/vocab-seed-data");
async function seedVocabs(vocabs) {
    ...
    for (const vocabItem of vocabs) {
        ...
        const lesson = await lessonRepo.findOne({
            where: { lesson_number: vocabItem.lesson_number, level: (0, typeorm_1.In)(['N5', 'N4']) },
        });
        if (!lesson) {
            failedVocabs.push({
...
seedVocabs(vocab_seed_data_1.vocabSeedData)
    .catch((err) => {
...
//# sourceMappingURL=seed-vocabs.js.map